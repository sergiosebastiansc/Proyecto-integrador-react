...
export default function Account() {
    const { currentUser, updateUser, changePassword, logoutUser } = useApp()
            ...
            <div className="contenedor-center">
                <div style={{ width: '100%', maxWidth: '600px' }}>
                        ...
                        {isEditing ? (
                            ...
                            <div className="account-data">
                                ...
                                <div className="data-row">
                                    ...
                                    <span>{currentUser?.company || 'No especificada'}</span>
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div style={{ marginTop: '2rem', textAlign: 'center' }}>
                        <button className="btn-danger" onClick={handleLogout} style={{ padding: '1rem 2rem' }}>
                            CERRAR SESIÓN
                        </button>
                    </div>
                </div>
